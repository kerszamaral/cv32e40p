...
#
# Script generated by Vivado on Fri Jan 12 11:03:10 -03 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dp_axi_bram.sh
...
#
# Usage        : dp_axi_bram.sh
#                dp_axi_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dp_axi_bram.sh [-reset_run]
#                dp_axi_bram.sh [-reset_log]
#                dp_axi_bram.sh [-help]
#
...
#                script (type 'dp_axi_bram.sh -help' for more information).
#
...
# script info
echo -e "dp_axi_bram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dp_axi_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+VERILATOR="VERILATOR" \
  ...
  vlogan -work blk_mem_gen_v8_4_7 $vlogan_opts +v2k +define+VERILATOR="VERILATOR" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+VERILATOR="VERILATOR" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dp_axi_bram xil_defaultlib.glbl -o dp_axi_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dp_axi_bram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kersz/Documents/cv32e40p/cv32e40p.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dp_axi_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dp_axi_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dp_axi_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dp_axi_bram.sh [-help]\n\
Usage: dp_axi_bram.sh [-step]\n\
Usage: dp_axi_bram.sh [-lib_map_path]\n\
Usage: dp_axi_bram.sh [-reset_run]\n\
Usage: dp_axi_bram.sh [-reset_log]\n\
Usage: dp_axi_bram.sh [-keep_index]\n\
Usage: dp_axi_bram.sh [-noclean_files]\n\n\
