...
elaborate()
{
  xelab --debug typical --relax --mt 2 -d "VERILATOR=VERILATOR"  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dp_axi_bram xil_defaultlib.dp_axi_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dp_axi_bram -key {Behavioral:sim_1:Functional:dp_axi_bram} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex -testplusarg verbose
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dp_axi_bram.wdb xsim.dir libdpi.so)
