...
#
# Script generated by Vivado on Tue Nov 21 14:51:19 -03 2023
...
# script info
echo -e "dp_blk_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dp_blk_ram xil_defaultlib.dp_blk_ram xil_defaultlib.glbl -log elaborate.log
}
