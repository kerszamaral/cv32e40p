...
#                script (type 'axi_bram_ctrl_2.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_bram_ctrl_2 xil_defaultlib.glbl -o axi_bram_ctrl_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_bram_ctrl_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_bram_ctrl_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_bram_ctrl_2_simv.daidir vcs_lib c.obj)
