...
#
# Script generated by Vivado on Fri Nov 10 16:47:11 -0300 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : axi_bram_ctrl_2.sh
...
#
# Usage        : axi_bram_ctrl_2.sh
#                axi_bram_ctrl_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_bram_ctrl_2.sh [-reset_run]
#                axi_bram_ctrl_2.sh [-reset_log]
#                axi_bram_ctrl_2.sh [-help]
#
...
# script info
echo -e "axi_bram_ctrl_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_bram_ctrl_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_2 xil_defaultlib.axi_bram_ctrl_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_bram_ctrl_2 -key {Behavioral:sim_1:Functional:axi_bram_ctrl_2} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex -testplusarg verbose
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_bram_ctrl_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_bram_ctrl_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_bram_ctrl_2.sh [-help]\n\
Usage: axi_bram_ctrl_2.sh [-step]\n\
Usage: axi_bram_ctrl_2.sh [-lib_map_path]\n\
Usage: axi_bram_ctrl_2.sh [-reset_run]\n\
Usage: axi_bram_ctrl_2.sh [-reset_log]\n\
Usage: axi_bram_ctrl_2.sh [-keep_index]\n\
Usage: axi_bram_ctrl_2.sh [-noclean_files]\n\n\
