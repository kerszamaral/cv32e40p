...
#
# Script generated by Vivado on Tue Jan 16 20:21:17 -0300 2024
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0_2/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0_2/hdl" \
