...
#
# Script generated by Vivado on Tue Jan 09 11:19:50 -03 2024
...
# script info
echo -e "axi_crossbar_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_crossbar_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_crossbar_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_crossbar_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
