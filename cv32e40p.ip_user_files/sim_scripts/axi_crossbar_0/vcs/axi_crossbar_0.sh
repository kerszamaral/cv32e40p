...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+VERILATOR="VERILATOR" +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+VERILATOR="VERILATOR" +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0/hdl" \
