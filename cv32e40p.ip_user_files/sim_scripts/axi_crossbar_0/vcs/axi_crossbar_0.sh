...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +define+VERILATOR="VERILATOR" +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0_2/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +define+VERILATOR="VERILATOR" +incdir+"../../../../cv32e40p.gen/sources_1/ip/axi_crossbar_0_2/hdl" \
...
reset_run()
{
  files_to_remove=(ucli.key axi_crossbar_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_crossbar_0_simv.daidir vcs_lib c.obj)
