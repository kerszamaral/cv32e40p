...
elaborate()
{
  xelab --debug typical --relax --mt 2 -d "VERILATOR=VERILATOR"  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_crossbar_0 xil_defaultlib.axi_crossbar_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_crossbar_0 -key {Behavioral:sim_1:Functional:axi_crossbar_0} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex -testplusarg verbose
}
