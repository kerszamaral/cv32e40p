...
#                script (type 'dp_ipgen_ram.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dp_ipgen_ram xil_defaultlib.glbl -o dp_ipgen_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dp_ipgen_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dp_ipgen_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dp_ipgen_ram_simv.daidir vcs_lib c.obj)
