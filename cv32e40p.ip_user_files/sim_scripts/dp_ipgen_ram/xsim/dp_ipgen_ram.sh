...
#
# Script generated by Vivado on Mon Oct 30 22:29:23 -0300 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dp_ipgen_ram.sh
...
#
# Usage        : dp_ipgen_ram.sh
#                dp_ipgen_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dp_ipgen_ram.sh [-reset_run]
#                dp_ipgen_ram.sh [-reset_log]
#                dp_ipgen_ram.sh [-help]
#
...
# script info
echo -e "dp_ipgen_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dp_ipgen_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dp_ipgen_ram xil_defaultlib.dp_ipgen_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dp_ipgen_ram -key {Behavioral:sim_1:Functional:dp_ipgen_ram} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dp_ipgen_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dp_ipgen_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dp_ipgen_ram.sh [-help]\n\
Usage: dp_ipgen_ram.sh [-step]\n\
Usage: dp_ipgen_ram.sh [-lib_map_path]\n\
Usage: dp_ipgen_ram.sh [-reset_run]\n\
Usage: dp_ipgen_ram.sh [-reset_log]\n\
Usage: dp_ipgen_ram.sh [-keep_index]\n\
Usage: dp_ipgen_ram.sh [-noclean_files]\n\n\
