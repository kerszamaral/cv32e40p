...
#
# Script generated by Vivado on Wed Dec 06 12:13:19 -0300 2023
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_to_bram xil_defaultlib.axi_to_bram xil_defaultlib.glbl -log elaborate.log
}
