...
#
# Script generated by Vivado on Fri Nov 24 12:54:56 -03 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_to_bram xil_defaultlib.axi_to_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_to_bram -key {Behavioral:sim_1:Functional:axi_to_bram} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex -testplusarg verbose
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_to_bram.wdb xsim.dir libdpi.so)
