...
#
# Script generated by Vivado on Thu Jan 11 12:34:21 -03 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_to_bram.sh
...
#
# Usage        : axi_to_bram.sh
#                axi_to_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_to_bram.sh [-reset_run]
#                axi_to_bram.sh [-reset_log]
#                axi_to_bram.sh [-help]
#
...
#                script (type 'axi_to_bram.sh -help' for more information).
#
...
# script info
echo -e "axi_to_bram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_to_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_to_bram xil_defaultlib.glbl -o axi_to_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_to_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_to_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_to_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_to_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_to_bram.sh [-help]\n\
Usage: axi_to_bram.sh [-step]\n\
Usage: axi_to_bram.sh [-lib_map_path]\n\
Usage: axi_to_bram.sh [-reset_run]\n\
Usage: axi_to_bram.sh [-reset_log]\n\
Usage: axi_to_bram.sh [-keep_index]\n\
Usage: axi_to_bram.sh [-noclean_files]\n\n\
