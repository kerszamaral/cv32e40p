...
#
# Script generated by Vivado on Tue Jan 09 22:28:28 -0300 2024
...
elaborate()
{
  xelab --debug typical --relax --mt 2 -d "VERILATOR=VERILATOR"  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_uartlite_0 xil_defaultlib.axi_uartlite_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_uartlite_0 -key {Behavioral:sim_1:Functional:axi_uartlite_0} -tclbatch cmd.tcl -log simulate.log -testplusarg firmware=C:/Users/kersz/Documents/ufrgs/IC/cv32e40p/programs/prog.hex -testplusarg verbose
}
